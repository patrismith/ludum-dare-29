...
Mer.TankStage.prototype = Mer.StageConstructor.Lab('Tank','background', 256,
...
Mer.Hallway01Stage.prototype = Mer.StageConstructor.Lab('Hallway01','background', 512,
                                                   [{x:70,y:100},{x:80,y:100}],
                                                   [],
                                                   [{leadsTo: 'Bathroom', x: 128, y:104, playerX: 10},
                                                    {leadsTo: 'Tank', x: 0, y:104, playerX: 224}],
                                                   true);

Mer.BathroomStage.prototype = Mer.StageConstructor.Lab('Bathroom','background', 128,
                                                      //{x:20,y:104},
                                                      [],
